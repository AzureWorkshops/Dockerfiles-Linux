...
#### Get Public IP
  ...
  2. In the top section of the blade, in the right column, you should see a **Public IP address** listed. <img src="../../images/centos_ip_address.jpg" class="block"/>
...
#### Connect with SSH
  ...
  2. In the configuration window:  
      ...
      * Port: **22**
      * Connection type: **SSH**   
<img src="../../images/centos_putty_configuration.jpg" class="block"/>
